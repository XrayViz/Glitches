...
#if (len(sys.argv) < 5):
#    print("Usage: nk_calc_error_rev.py  file_with_exp_E")
#    sys.exit(0)
...
angStep = 0.01*m.pi/float(180)
omStart = 1.93*m.pi/float(180)
omEnd = 1.95*m.pi/float(180)
phStart = 0.14*m.pi/float(180)
phEnd = 0.16*m.pi/float(180)
ucStep = 0.0001
ucStart = 3.566
ucEnd = 3.568
...
for uc in np.arange(ucStart, ucEnd+ucStep, ucStep):
  cell_a = uc
